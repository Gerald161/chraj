      ...
      <div className="flex items-center justify-center min-h-screen p-8">
        <div className="w-full max-w-2xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl font-bold mb-4">CHRAJ Respondent Portal</h1>
          ...
          <div className={`p-8 rounded-2xl shadow-xl backdrop-blur-sm transition-all duration-300 ${
            ...
            <div className="text-center mb-8">
              <h2 className="text-2xl font-semibold mb-3">Access Your Case</h2>
              <p className="opacity-75">Enter your case ID to view appointments and case information</p>
            </div>
