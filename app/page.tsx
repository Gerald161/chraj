...
export default function HomePage() {
  ...
  return (
    <div className={`min-h-screen ${themeClasses.bg} transition-colors duration-300`}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center space-x-3">
              ...
              <Link href={"/signin"} className="px-4 py-2 text-blue-600 border border-blue-600 rounded-lg hover:bg-blue-50 transition-colors cursor-pointer">
                Staff Login
              </Link>
            </div>
          </div>
          ...
          <div className="text-center mb-12">
            ...
            <div className="flex justify-center mb-8">
              <select 
                ...
                className={`px-6 py-3 rounded-lg border ${isDarkMode ? 'bg-gray-700/50 border-gray-600 text-white' : 'bg-white border-gray-300'}`}
              >
      ...
      {/* Footer */}
      <footer className={`${isDarkMode ? 'bg-gray-900' : 'bg-gray-800'} text-white py-16 transition-colors duration-300`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8 mb-12">
            ...
            <div className="md:col-span-2">
              <div className="flex items-center space-x-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-gray-300 text-sm">Commission on Human Rights & Administrative Justice</p>
                </div>
              </div>
              ...
              <div className="space-y-3">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-300 text-sm">Old Parliament House, High Street, Accra</span>
                </div>
                <div className="flex items-center space-x-3">
                  <Phone className="text-blue-400" size={16} />
                  <span className="text-gray-300 text-sm">+233 302 664763</span>
                </div>
                <div className="flex items-center space-x-3">
                  <Mail className="text-blue-400" size={16} />
                  <span className="text-gray-300 text-sm">info@chrajghana.com</span>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Our Mandate</a></li>
                <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Leadership</a></li>
                <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Contact Us</a></li>
                <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Procurement</a></li>
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li><a href="#" className="text-gray-300 hover:text-white transition-colors">File Complaint</a></li>
                <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Check Status</a></li>
                <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Human Rights</a></li>
                <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Anti-Corruption</a></li>
                <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Administrative Justice</a></li>
                <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Public Education</a></li>
              </ul>
            </div>
          </div>
